            ...
            <div class="py-8 px-4 mx-auto max-w-7xl lg:py-16">
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <x-dashboard.card class="bg-neutral-secondary-soft border border-default rounded-xl p-8 md:p-12" cardTitle="Applications">
                        <span class="inline-flex items-center bg-brand-softer text-fg-brand-strong text-xs font-medium py-0.5 rounded-xl">
                    ...
                    <x-dashboard.card class="bg-neutral-secondary-soft border border-default rounded-xl p-8 md:p-12">
                    ...
                    <x-dashboard.card class="bg-neutral-secondary-soft border border-default rounded-xl p-8 md:p-12 flex flex-col">
                        <span class="inline-flex items-center bg-brand-softer  text-fg-brand-strong text-xs font-medium py-0.5 rounded-sm">
                            <h4 class="text-heading text-3xl font-semobild my-4"> Your documents</h4>
                        </span>
