    ...
    <div class="bg-white ">
        <div class=" h-screen relative isolate   px-6  lg:px-8">
            ...
            <section class="mb-6">
                ...
                {{-- <div class="p-4 mb-4 text-sm text-blue-700 bg-blue-100 rounded-lg | flex flex-row justify-between" role="alert">
                <span class="font-medium">{{ $jobsAndApplicant->title }}</span>
                <div>
                    <a class="w-40 px-2 | mt-6 | text-white bg-green-500 hover:bg-green-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm py-2" href="/employer/edit_job/{{ $jobsAndApplicant->id }}">Edit</a>
                    <a class="w-40 px-2 | mt-6 | text-white bg-red-500 hover:bg-green-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm py-2" href="/employer/delete_job/{{ $jobsAndApplicant->id }}">Delete</a>
                </div>
        </div>--}}
        ...
        <div id="accordion-{{ $sectionIndex }}" class="w-full" data-accordion="collapse">
            ...
            <div id="accordion-body-{{ $sectionIndex }}" class="hidden" aria-labelledby="accordion-heading-{{ $sectionIndex }}">
                <div class="p-5 font-light border border-gray-200 border-t-0">
                    ...
                    {{-- {{ $applicant->applicantUsers->first_name }} --}}
