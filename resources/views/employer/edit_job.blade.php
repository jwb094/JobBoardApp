                        ...
                        <div class="grid gap-4 sm:grid-cols-1 sm:gap-6">
                            <div class="step active">
                                ...
                                <div class="sm:col-span-2">
                                    <label for="job_title" class="block my-4 text-sm font-medium text-gray-900 dark:text-black">Job Title</label>
                                ...
                                <div class="sm:col-span-2">
                                    <label for="company_tel" class="block my-4 text-sm font-medium text-gray-900 dark:text-black">Minimum Salary </label>
                                ...
                                <div class="sm:col-span-2">
                                    <label for="salary_max" class="block my-4 text-sm font-medium text-gray-900 dark:text-black">Maximum Salary </label>
                                ...
                                <div class="sm:col-span-2">
                                    <label for="job_type" class="block my-4 text-sm font-medium text-gray-900 dark:text-black">Job Type </label>
                                ...
                                <div class="sm:col-span-2">
                                    <label for="status" class="block my-4 text-sm font-medium text-gray-900 dark:text-black">Job Type </label>
                            ...
                            <div class="step">
                                <div class="sm:col-span-2">
                                    <label for="company_Desc" class="block my-4 text-sm font-medium text-gray-900 dark:text-black">Company Background Description </label>
